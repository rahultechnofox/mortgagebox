        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Need Spam</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{'/'}}">Dashboard</a>
                                    </li>
                                <li class="breadcrumb-item active">Need Spam List</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog sidebar-sm">
                <form class="add-new-record modal-content pt-0" id="servicesForm" method="post">
                    ...
                    <div class="modal-body flex-grow-1">
                        ...
                        <button type="button" class="btn btn-primary data-submit me-1" id="createBtn" onclick="refundPayment('{{$users_data->id}}','1');">Yes</button>
                        <button type="button" class="btn btn-outline-secondary" onclick="refundPayment('{{$users_data->id}}','0');">No</button>
                    </div>
                </form>
            </div>
        </div>
