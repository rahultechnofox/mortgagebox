        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0"><?php if(isset($_GET['type']) && $_GET['type']!=''){ echo ucfirst($_GET['type']); }?> Pages</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('admin')}}">Dashboard</a>
                                    </li>
                                <li class="breadcrumb-item active"><?php if(isset($_GET['type']) && $_GET['type']!=''){ echo ucfirst($_GET['type']); }?> Pages List</li>
                            </ol>
                        </div>
                    </div>
                </div>
