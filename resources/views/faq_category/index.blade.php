                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2 col-12">
                            <select class="form-select" name="status">    
                                ...
                                <option value="1" <?php if(isset($_GET['status'])){ if($_GET['status']==1){ echo "selected"; } } ?>>Active</option>
                                <option value="0" <?php if(isset($_GET['status'])){ if($_GET['status']==0){ echo "selected"; } } ?>>Deactive</option>
                            </select>
                        </div>
                        <div class="col-md-2 col-12">
