                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($users_data->spam_status == 1)
                                        <a class="btn btn-success btn-sm btn-add-new waves-effect waves-float waves-light">Yes</a>
                                    @else
                                        <a class="btn btn-danger btn-sm btn-add-new waves-effect waves-float waves-light">No</a>
                                    @endif
                                </td>
