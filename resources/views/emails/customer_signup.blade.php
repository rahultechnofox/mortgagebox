          ...
          <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
             <tr>
                <td align="left" valign="top">
                   ...
                   <div style="height: 20px; line-height: 20px; font-size: 18px;">&nbsp;</div>
                   <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 32px;">
                      <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 18px; line-height: 24px;">To activate your account and start finding mortgage advisers, click on the following link.</span>
                   </font>
                      ...
                      <tr>
                         <td align="center" valign="middle" height="55">
                            <a href="{{$url}}" target="_blank" style="display: inline-block; width: 120px; height: 55px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 55px; text-decoration: none; white-space: nowrap; font-weight: 600; background: #427af1; border-radius:5px; padding:0 15px;">
                                  <span style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 55px; text-decoration: none; white-space: nowrap; width:120px; margin: auto; font-weight: 600;">Verify</span>
                            </a>
                         </td>
                      </tr>
                   </table>
