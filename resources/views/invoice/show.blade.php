						...
						<div class="card invoice-preview-card">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
                                        @if(isset($row->new_fees_arr) && count($row->new_fees_arr)>0)
                                            @foreach($row->new_fees_arr as $new_fees_data)
												<tr>
							...
							<div class="table-responsive">
								<table class="table">
									...
									<tbody>
                                        @if(isset($row->discount_credit_arr) && count($row->discount_credit_arr)>0)
                                            @foreach($row->discount_credit_arr as $discount_credits_data)
												<tr>
